      ...
      const allSalles = salles
        .map((salle) => {
          ...
          <tr>
              ...
              <td>
              <button type="button" class="btnu btn-secondary" data-blocid="${bloc._id}" data-bloc="${bloc.nom}" data-type="${type}" data-nom="${nom}" data-id="${salleID}">
              <i>modifier</i>
              </button>
              </td>
              <td>
              <button type="button" class="btnd btn-danger" data-id="${salleID}">
              <i>supprimer</i>
              </button>
              </td>
            </tr>
